  ...
  private applyFilters(): void {
    ...
    if (this.searchTerm && this.searchTerm.trim()) {
      ...
      filteredPrestamos = filteredPrestamos.filter(prestamo => {
        ...
        const normalizedLectorId = this.normalizeText(prestamo.lectorId);
        const normalizedBibliografiaId = this.normalizeText(prestamo.bibliografiaId);
        ...
        return searchTerms.every(term => 
          ...
          normalizedLectorId.includes(term) ||
          normalizedBibliografiaId.includes(term)
        );
      });
    }
